namespace OpenFlow_PluginFramework.Registration
{
    ...
    public interface IPluginHost
    {
        ...
        /// </summary>
        /// <typeparam name="TNode1">The type of the first <see cref="INode"/></typeparam>
        /// <typeparam name="TNode2">The type of the second <see cref="INode"/></typeparam>
        ...
        /// <typeparam name="TNode1">The type of the first <see cref="INode"/></typeparam>
        /// <typeparam name="TNode2">The type of the second <see cref="INode"/></typeparam>
        /// <typeparam name="TNode3">The type of the third <see cref="INode"/></typeparam>
        /// <param name="menuItemName">The name of the root menu to add them to</param>
        /// <param name="subItemName">The name of the sub menu to add them to</param>
        ...
        /// <typeparam name="TNode2">The type of the second <see cref="INode"/></typeparam>
        /// <typeparam name="TNode3">The type of the third <see cref="INode"/></typeparam>
        /// <typeparam name="TNode4">The type of the fourth <see cref="INode"/></typeparam>
        /// <param name="menuItemName">The name of the root menu to add them to</param>
        /// <param name="subItemName">The name of the sub menu to add them to</param>
        ...
        /// <typeparam name="TNode3">The type of the third <see cref="INode"/></typeparam>
        /// <typeparam name="TNode4">The type of the fourth <see cref="INode"/></typeparam>
        /// <typeparam name="TNode5">The type of the fifth <see cref="INode"/></typeparam>
        /// <param name="menuItemName">The name of the root menu to add them to</param>
        /// <param name="subItemName">The name of the sub menu to add them to</param>
        ...
        /// <typeparam name="TNode4">The type of the fourth <see cref="INode"/></typeparam>
        /// <typeparam name="TNode5">The type of the fifth <see cref="INode"/></typeparam>
        /// <typeparam name="TNode6">The type of the sixth <see cref="INode"/></typeparam>
        /// <param name="menuItemName">The name of the root menu to add them to</param>
        /// <param name="subItemName">The name of the sub menu to add them to</param>
        ...
        /// <typeparam name="TNode5">The type of the fifth <see cref="INode"/></typeparam>
        /// <typeparam name="TNode6">The type of the sixth <see cref="INode"/></typeparam>
        /// <typeparam name="TNode7">The type of the seventh <see cref="INode"/></typeparam>
        /// <param name="menuItemName">The name of the root menu to add them to</param>
        /// <param name="subItemName">The name of the sub menu to add them to</param>
        ...
        /// <typeparam name="TNode6">The type of the sixth <see cref="INode"/></typeparam>
        /// <typeparam name="TNode7">The type of the seventh <see cref="INode"/></typeparam>
        /// <typeparam name="TNode8">The type of the eighth <see cref="INode"/></typeparam>
        /// <param name="menuItemName">The name of the root menu to add them to</param>
        /// <param name="subItemName">The name of the sub menu to add them to</param>
