...
{
    public IValueInput<T> ValueInput<T>(string valueName, T initialValue, IUserInterfaceDefinition? editor = null, IUserInterfaceDefinition? viewer = null, Action<T>? valueAutoSetter = null);
