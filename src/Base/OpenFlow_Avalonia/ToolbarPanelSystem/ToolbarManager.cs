namespace OpenFlow_Avalonia.ToolbarPanelSystem
{
    ...
    using OpenFlow_Avalonia.Utils;
    using OpenFlow_Avalonia.Utils.CloningSystem;
    ...
    public class ToolbarManager : Animatable
    {
        ...
        public Canvas GripCanvas => this.parent.DrawingCanvas;

        public Size DesiredSize => this.childToolbar.DesiredSize;

        public int Level => ToolbarPanel.GetLevel(this.childToolbar);

        public double MinDepth => this.Orientation == Orientation.Horizontal ? this.childToolbar.Height : this.childToolbar.Width;
        ...
        private void ClickArea_PointerPressed(object sender, PointerPressedEventArgs e)
        {
            ...
            if (e.KeyModifiers == KeyModifiers.Control && Cloner.TryClone(childToolbar, out IControl newControl))
            {
                ToolbarPanel.SetDockDirection(newControl, ToolbarPanel.DockDirection.None);
