...
public class ColorInitialization(Application topLevel) : IAfterApplicationBuiltTarget
{
    ...
    public void OnApplicationBuilt()
    {
        ...
        topLevel.Resources.GetResourceObservable("LaminarThemeAccent").Subscribe(new Domain.Observables.Value.AnonymousObserver<object?>(primary =>
        {
        ...
        topLevel.Resources.GetResourceObservable("LaminarThemeForeground").Subscribe(new Domain.Observables.Value.AnonymousObserver<object?>(foreground =>
        {
        ...
        topLevel.Resources.GetResourceObservable("LaminarThemeBackground").Subscribe(new Domain.Observables.Value.AnonymousObserver<object?>(background =>
        {
